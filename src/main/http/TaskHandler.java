...
public class TaskHandler extends BaseHttpHandler {
    public TaskHandler(TaskManager manager, Gson gson) { super(manager, gson); }
    ...
    private void handleGet(HttpExchange h) throws IOException {
        ...
        if (t == null) { sendNotFound(h, "Task id=" + id + " not found"); return; }
    ...
    private void handleDelete(HttpExchange h) throws IOException {
        ...
        int id = idOpt.get();
        if (manager.getTaskById(id) == null) { sendNotFound(h, "Task id=" + id + " not found"); return; }
